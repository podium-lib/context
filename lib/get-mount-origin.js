...
const ContextMountOriginParser = class ContextMountOriginParser {
    constructor(mount = {}) {
    ...
    get [Symbol.toStringTag]() {
        return 'ContextMountOriginParser';
    }
    ...
    parse(req) {
        return new Promise(resolve => {
            ...
            const hostArr = (req.headers && req.headers.host) ? req.headers.host.split(':') : ['localhost'];
...
module.exports = ContextMountOriginParser;
