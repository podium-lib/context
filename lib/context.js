...
const getRequestedBy = require('./get-requested-by');
const getDeviceType = require('./get-device-type');
...
module.exports = class ContextResolver {
    constructor(
        ...
        this.parser('domain', getToplevelDomain);
        this.parser('session-id', getSessionId);
        this.parser('trace-id', getTraceId);
        this.parser('visitor-id', getVisitorId);
        this.parser('locale', getLocale);
        this.parser('debug', getDebug);
        this.parser('requested-by', getRequestedBy);
        this.parser('device-type', getDeviceType);
    }
